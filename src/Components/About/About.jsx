      ...
      <div className="about">
        <div className="about-right stiff-block">
          ...
          <p>
            ...
            Varija Bajaj, Pooja Motwani, Rahul Dutta, Suvo Das, Meenakshi Dutta,
            Gunjan Gaur, Akash K Agarwal and Lt. Rita gangwani in past issues.
          </p>
          ...
          <p>
            The Bollywood Faces’s unveiling ceremony is through an event which
            provides an opportunity for networking with industry stalwart and
            socialite. As this event revolve around a social issue, so it gives
            the platform to fulfill the social responsibility also
          </p>
        </div>
